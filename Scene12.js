class Scene12 extends Phaser.Scene {
 ...
 ////NIVEL 1
    create ()
    {
        ...
        this.physics.add.collider(escuela, player, this.scene13, null, this);
       ...
       bot4 = this.add.image(1200, 600,'next').setInteractive().on('pointerdown', ()=>{this.physics.resume(); pausacont = 0; instruccionestext.destroy(); instrucciones4.destroy();this.selecsound.play(); instruccionestext5.destroy();logo.destroy(); logo2.destroy();bot4.destroy();
     ...
     .setInteractive().on('pointerdown', ()=>{if(sonion ===0){ game.sound.mute = true;sonion = 1;}
       ...
       instruccionestext2 = this.add.bitmapText(125, 750, 'pixel', '- Press space key or' + 
       ' the on-screen button to jump.', 30).setTint(0x000000)
       ...
       instruccionestext3 = this.add.bitmapText(260,750, 'pixel', '- Combine sanitizers to score points.', 30).setTint(0x000000)
       ...
       instruccionestext = this.add.bitmapText(330, 322, 'pixel', 'Instructions Level 1', 40).setTint(0xffffff)
       instruccionestext4 = this.add.bitmapText(300,750, 'pixel', '- Click on the sinks to go faster.', 30).setTint(0x000000)
       ...
       infotext = this.add.bitmapText(530, 322, 'pixel', 'Origin', 40).setTint(0xffffff)
       ...
       infotext2 = this.add.bitmapText(40,750, 'pixel', 'The origin of the infection is a variant of the H1N1 strain,' + 
    ...
    pausa(){
        ...
        pausa2 = this.add.image(player.x, 540, 'pausamadera');
        var t1 = this.add.bitmapText(player.x-140,360, 'pixel', 'Resume', 60).setTint(0x21911d);
        ...
        var t2 = this.add.bitmapText(player.x-155, 530, 'pixel','Restart', 60).setTint(0x63370a);
        ...
        var t3 =this.add.bitmapText(player.x-90, 680, 'pixel','Exit', 60).setTint(0xecd313);
    ...
    powerup (player, powerup){
        ...
        puntos = puntos+100;
        if (puntos === 100){
            ve = this.add.bitmapText(520,500,'pixel', 'Go to school!').setTint(0xFFFFFF);
            }
        else {
            ve.destroy();
        }
