class Scene17 extends Phaser.Scene {
  ...
  .setInteractive().on('pointerdown', ()=>{if(sonion ===0){ game.sound.mute = true;sonion = 1;}
    ...
    scoreText.setScrollFactor(0).setDepth(2);});
     ...
     instruccionestext6 = this.add.bitmapText(50,720, 'pixel', '- Click on the viruses to eliminate them and score points.', 30).setTint(0x000000)
    ...
    instruccionestext2 = this.add.bitmapText(125, 750, 'pixel', '- Press space key or the on-screen button to jump.', 30).setTint(0x000000)
    ...
    instruccionestext = this.add.bitmapText(330, 322, 'pixel', 'Instructions Level 2', 40).setTint(0xffffff)
    instruccionestext4 = this.add.bitmapText(170, 750, 'pixel', '- Click on the windows to keep the virus away.', 30).setTint(0x000000)
    ...
    infotext = this.add.bitmapText(525, 322, 'pixel', 'Symptoms', 40).setTint(0xffffff)
    ...
    bot5 = this.add.image(1200, 600,'next').setInteractive().on('pointerdown', ()=>{info1.destroy(), infotext.destroy(); bot5.destroy();this.selecsound.play();infotext3.destroy()});
  }
  ...
  powerup(player, powerup) {
    ...
    puntos = puntos + 100;
    if (puntos === 100){
      ve = this.add.bitmapText(750,500,'pixel', 'Get to the end of the hall!').setTint(0xFFFFFF);
      }
    else {
      ve.destroy();
  }
