 ...
 ////NIVEL 1
    create ()
    {
     ...
     .setInteractive().on('pointerdown', ()=>{if(sonion ===0){ game.sound.mute = true;sonion = 1;}
       ...
       instruccionestext3 = this.add.bitmapText(140,750, 'pixel', '- Junta los alcoholes en gel para sumar puntos.', 30).setTint(0x000000);
       ...
       instruccionestext = this.add.bitmapText(330, 322, 'pixel', 'Instrucciones Etapa 1', 40).setTint(0xffffff);
       instruccionestext4 = this.add.bitmapText(110,750, 'pixel', '- Haz click sobre los lavatorios para ir más rápido.', 30).setTint(0x000000);
       ...
       infotext = this.add.bitmapText(530, 322, 'pixel', 'Origen', 40).setTint(0xffffff);
       ...
       infotext2 = this.add.bitmapText(50,750, 'pixel', 'El origen de la infección es una variante de la cepa H1N1,' + 
       ...
       bot5 = this.add.image(1200, 600,'next').setInteractive().on('pointerdown', ()=>{info1.destroy(), infotext.destroy(), bot5.destroy(),this.selecsound.play(), infotext2.destroy();
    ...
    powerup (player, powerup){
        ...
        puntos = puntos+100;
        if (puntos === 100){
            ve = this.add.bitmapText(520,500,'pixel', 'Ve hacia la escuela!').setTint(0xFFFFFF);
            }
        else {
            ve.destroy();
        }
