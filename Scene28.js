class Scene28 extends Phaser.Scene{
    ...
    create(){
      ...
      .setInteractive().on('pointerdown', ()=>{if(sonion ===0){ game.sound.mute = true;sonion = 1;}
        ...
        instruccionestext3 = this.add.bitmapText(180,750, 'pixel', '- Colete os álcoois de gel para marcar pontos' + 
        '\n                  e aumentar sua velocidade.', 30).setTint(0x000000)
        ...
        instruccionestext = this.add.bitmapText(370, 322, 'pixel', 'Instruções Palco 3', 40).setTint(0xffffff)
        instruccionestext4 = this.add.bitmapText(110,750, 'pixel', '- Clique nos vírus para removê-los e ganhar pontos.', 30).setTint(0x000000)
        ...
        infotext = this.add.bitmapText(480, 322, 'pixel', 'Prevenção', 40).setTint(0xffffff)
    ...
    puntos = puntos+100;
    if (100 >= puntos <= 190){
        ve = this.add.bitmapText(620,500,'pixel', 'Vá ao hospital!').setTint(0xFFFFFF);
        }
    else {
        ve.destroy();
    }
    ...
    pausa2 = this.add.image(player.x, 545, 'pausamadera').setDepth(5.1);
    var t1 = this.add.bitmapText(player.x-200,360, 'pixel', 'Currículo', 60).setDepth(5.2).setTint(0x21911d);
    ...
    var t2 = this.add.bitmapText(player.x-200, 530, 'pixel','Reiniciar', 60).setDepth(5.2).setTint(0x63370a);
    ...
    var t3 =this.add.bitmapText(player.x-90, 680, 'pixel','Saia', 60).setDepth(5.2).setTint(0xecd313);
