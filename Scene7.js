class Scene7 extends Phaser.Scene {
  ...
  create() {
   ...
   scoreText.setScrollFactor(0).setDepth(2);});
     ...
     instruccionestext6 = this.add.bitmapText(30,750, 'pixel', '- Haz click sobre los virus para eliminarlos y sumar puntos.', 30).setTint(0x000000)
     bot6 = this.add.image(1200, 600,'next').setInteractive().on('pointerdown', ()=>{instrucciones5.destroy(), instruccionestext6.destroy(), bot6.destroy(),this.selecsound.play()});
    ...
    instruccionestext2 = this.add.bitmapText(75, 750, 'pixel', '- Con la tecla "espacio" o el botón en pantalla, salta!.', 30).setTint(0x000000)
    ...
    instruccionestext3 = this.add.bitmapText(150,750, 'pixel', '- Junta los alcoholes en gel para sumar puntos.', 30).setTint(0x000000)
    ...
    instruccionestext = this.add.bitmapText(330, 322, 'pixel', 'Instrucciones Etapa 2', 40).setTint(0xffffff)
    instruccionestext4 = this.add.bitmapText(110, 750, 'pixel', '- Haz click sobre las ventanas para alejar al virus.', 30).setTint(0x000000)
    ...
    infotext = this.add.bitmapText(505, 322, 'pixel', 'Síntomas', 40).setTint(0xffffff)
  ...
  powerup(player, powerup) {
    ...
    puntos = puntos + 100;
    if (puntos === 100){
      ve = this.add.bitmapText(750,500,'pixel', 'Llega al final del pasillo!').setTint(0xFFFFFF);
      }
    else {
      ve.destroy();
  }
  ...
  pausa() {
    ...
    var t1 = this.add.bitmapText(player.x-170,360, 'pixel', 'Reanudar', 60).setTint(0x21911d);
        reanudartext = this.add.image(player.x-20,385,'madera').setAlpha(0.0000000001).setScale(0.4,1)
        ...
        var t2 = this.add.bitmapText(player.x-190, 530, 'pixel','Reiniciar', 60).setTint(0x63370a);
        restartButton = this.add.image(player.x-20, 555,'madera').setAlpha(0.0000000001).setScale(0.4,1)
        .setInteractive().on('pointerdown', () =>{ this.selecsound.play(), this.reiniciar()});
        var t3 =this.add.bitmapText(player.x-115, 680, 'pixel','Salir', 60).setTint(0xecd313);
        menu = this.add.image(player.x-40, 705,'madera').setAlpha(0.0000000001).setScale(0.3,1)
