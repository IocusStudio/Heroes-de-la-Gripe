class pontosfinali extends Phaser.Scene{
    constructor(){
        super('hsp');
    }
    ...
    create() {
        ...
        logo = this.add.bitmapText(255, 55, 'pixel', 'Heróis da gripe', 70).setTint(0xF00909)
       logo2 = this.add.bitmapText(260, 50, 'pixel', 'Heróis da gripe', 70).setTint(0xE7BB09)
        ...
        if(plevelfinal <= juan){
            this.add.bitmapText(420, 530, 'pixel', 'VOCÊ:  ' + plevelfinal, 60 ).setTint(0x000000);
            ...
            this.add.bitmapText(426, 524, 'pixel', 'VOCÊ:  ' + plevelfinal, 60 ).setTint(0x08ff10);
            ...
            this.add.bitmapText(420, 430, 'pixel', 'VOCÊ:  ' + plevelfinal, 60 ).setTint(0x000000);
            this.add.bitmapText(425, 530, 'pixel', 'JUAN:  ' + juan, 60 ).setTint(0x000000);
            this.add.bitmapText(425, 330, 'pixel', 'LUCHO:  ' + lucho, 60 ).setTint(0x000000);
            this.add.bitmapText(428, 230, 'pixel', 'NICO:  ' + nico, 60 ).setTint(0x000000);

            this.add.bitmapText(426, 424, 'pixel', 'VOCÊ:  ' + plevelfinal, 60 ).setTint(0x08ff10);
            this.add.bitmapText(431, 524, 'pixel', 'JUAN:  ' + juan, 60 ).setTint(0x03A6B0);
            this.add.bitmapText(431, 324, 'pixel', 'LUCHO:  ' + lucho, 60 ).setTint(0xD0D308);
            this.add.bitmapText(436, 224, 'pixel', 'NICO:  ' + nico, 60 ).setTint(0xD30808);
        } else if(plevelfinal >= lucho && plevelfinal < nico){
            this.add.bitmapText(420, 330, 'pixel', 'VOCÊ:  ' + plevelfinal, 60 ).setTint(0x000000);
            this.add.bitmapText(425, 530, 'pixel', 'JUAN:  ' + juan, 60 ).setTint(0x000000);
            this.add.bitmapText(425, 430, 'pixel', 'LUCHO:  ' + lucho, 60 ).setTint(0x000000);
            this.add.bitmapText(428, 230, 'pixel', 'NICO:  ' + nico, 60 ).setTint(0x000000);

            this.add.bitmapText(426, 324, 'pixel', 'VOCÊ:  ' + plevelfinal, 60 ).setTint(0x08ff10);
            this.add.bitmapText(431, 524, 'pixel', 'JUAN:  ' + juan, 60 ).setTint(0x03A6B0);
            this.add.bitmapText(431, 424, 'pixel', 'LUCHO:  ' + lucho, 60 ).setTint(0xD0D308);
            this.add.bitmapText(436, 224, 'pixel', 'NICO:  ' + nico, 60 ).setTint(0xD30808);
        } else if(plevelfinal >= nico){
            this.add.bitmapText(420, 230, 'pixel', 'VOCÊ:  ' + plevelfinal, 60 ).setTint(0x000000);
            this.add.bitmapText(425, 530, 'pixel', 'JUAN:  ' + juan, 60 ).setTint(0x000000);
            this.add.bitmapText(425, 430, 'pixel', 'LUCHO:  ' + lucho, 60 ).setTint(0x000000);
            this.add.bitmapText(428, 330, 'pixel', 'NICO:  ' + nico, 60 ).setTint(0x000000);

            this.add.bitmapText(420, 224, 'pixel', 'VOCÊ:  ' + plevelfinal, 60 ).setTint(0x08ff10);
            this.add.bitmapText(431, 524, 'pixel', 'JUAN:  ' + juan, 60 ).setTint(0x03A6B0);
            this.add.bitmapText(431, 424, 'pixel', 'LUCHO:  ' + lucho, 60 ).setTint(0xD0D308);
        ...
        this.add.bitmapText(898, 672, 'pixel','MENU PRINCIPAL', 30).setTint(0x000000);//sombra del texto
        this.add.bitmapText(900, 670, 'pixel','MENU PRINCIPAL', 30).setTint(0x404FFA);
    }
